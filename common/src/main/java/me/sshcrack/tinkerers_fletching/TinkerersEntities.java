...
public class TinkerersEntities {
    ...
    public static final RegistrySupplier<EntityType<StormChargeEntity>> STORM_CHARGE = register("storm_charge", StormChargeEntity::new, b -> b.dimensions(0.6F, 1.77F).eyeHeight(1.3452F).maxTrackingRange(4).trackingTickInterval(10));
