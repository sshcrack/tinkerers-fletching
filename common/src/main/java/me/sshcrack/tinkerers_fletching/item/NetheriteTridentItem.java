...
public class NetheriteTridentItem extends Item implements ProjectileItem {
    public static final int MIN_DRAW_DURATION = 10;
    public static final float ATTACK_DAMAGE = 8.0F;
    public static final float THROW_SPEED = -2.9F;
    ...
    public static AttributeModifiersComponent createAttributeModifiers() {
        return AttributeModifiersComponent.builder()
                ...
                .add(
                        ...
                        new EntityAttributeModifier(BASE_ATTACK_SPEED_MODIFIER_ID, THROW_SPEED, Operation.ADD_VALUE),
                        AttributeModifierSlot.MAINHAND
                )
                .build();
    }
                ...
                if (!(f > 0.0F) || playerEntity.isTouchingWaterOrRain()) {
                    if (!isAboutToBreak(stack)) {
                        ...
                        if (!world.isClient) {
                            ...
                            if (f == 0.0F) {
                                var tridentEntity = new NetheriteTridentEntity(world, playerEntity, stack);
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        var tridentEntity = new NetheriteTridentEntity(world, pos.getX(), pos.getY(), pos.getZ(), stack.copyWithCount(1));
